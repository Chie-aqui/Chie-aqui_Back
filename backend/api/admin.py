...
class UsuarioAdmin(admin.ModelAdmin):
    list_display = (
        'email', 'nome', 'date_joined',
    ) # AbstractUser usa 'date_joined'
...
class UsuarioConsumidorAdmin(admin.ModelAdmin):
    list_display = (
        'usuario_email', 'usuario_nome', 'usuario_data_cadastro',
    )
...
class UsuarioEmpresaAdmin(admin.ModelAdmin):
    list_display = (
        'razao_social', 'cnpj', 'usuario_email',
        'usuario_nome', 'usuario_data_cadastro',
    )
...
class EstatisticaEmpresaAdmin(admin.ModelAdmin):
    list_display = (
        'usuario_empresa', 'total_reclamacoes',
        'reclamacoes_resolvidas', 'reclamacoes_pendentes',
    )
...
class ReclamacaoAdmin(admin.ModelAdmin):
    list_display = (
        'titulo', 'usuario_consumidor', 'empresa',
        'status', 'data_criacao',
    )
...
class ArquivoAdmin(admin.ModelAdmin):
    list_display = (
        'nome_arquivo', 'reclamacao', 'tipo_arquivo',
        'data_upload',
    )
...
class RespostaReclamacaoAdmin(admin.ModelAdmin):
    list_display = (
        'reclamacao', 'empresa', 'status_resolucao',
        'data_criacao',
    )
...
class RelatorioAdmin(admin.ModelAdmin):
    list_display = (
        'titulo', 'administrador', 'data_geracao',
    )
